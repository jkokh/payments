...
$certificate_path = "./QbixCertificate.p12";     // Change this to the path where your certificate is located
$certificate_password = "Qbix2017"; // Change this to the certificate's import password
